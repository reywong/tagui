        ...
        <div class="ibox-content no-padding">
            <ul class="list-group">
                <li class="list-group-item">
                    <p><a class="text-info" href="index.html#">@Alan Marry</a> I belive that. Lorem Ipsum is simply
                        dummy text of the printing and typesetting industry.</p>
                    <small class="block text-muted"><i class="fa fa-clock-o"></i> 1 minuts ago</small>
                </li>
                <li class="list-group-item">
                    <p><a class="text-info" href="index.html#">@Stock Man</a> Check this stock chart. This price is
                        crazy! </p>
                ...
                <li class="list-group-item">
                    <p><a class="text-info" href="index.html#">@Kevin Smith</a> Lorem ipsum unknown printer took a
                        galley </p>
